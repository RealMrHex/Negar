...
<head>
    ...
    <title inertia>.::Negar - Monitoring::.</title>

    <!-- Fonts -->
    <style>
        * {
            font-family: 'Dana-FaNum', serif;
        }
    </style>
        ...
        <div class="{{ $fullWidth ? '' : 'container' }} py-3 sm:py-5 mx-auto border-b border-gray-200 dark:border-gray-900">
            <div class="flex items-center justify-between">
                <div class="flex items-center dark:text-gray-300 text-gray-600">
                    <svg class="w-full h-4" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 290 73.79">
                        <defs>
                            <style>
                                .cls-1 {
                                    fill: currentColor;
                    ...
                    <span class="text-xs ml-2">Monitoring</span>
                </div>
